...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder> {
    ...
    public static final class CourseViewHolder extends RecyclerView.ViewHolder {
        ...
        public CourseViewHolder(@NonNull View itemView) {
            super(itemView);
            courseBg = itemView.findViewById(R.id.courseBackground);
            courseDate = itemView.findViewById(R.id.courseDate);
            courseImg = itemView.findViewById(R.id.courseImage);
            courseTitle = itemView.findViewById(R.id.courseTitleAaa);
    ...
    public void onBindViewHolder(@NonNull CourseAdapter.CourseViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.courseTitle.setText(courses.get(position).getCourseTitle());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation((Activity) context, new Pair<View, String>(holder.courseImg, "courseIgame"));

                intent.putExtra("courseBgColor", Color.parseColor(courses.get(position).getColor()));
                intent.putExtra("courseImage", imageId);
                intent.putExtra("courseTitle", courses.get(position).getCourseTitle());
